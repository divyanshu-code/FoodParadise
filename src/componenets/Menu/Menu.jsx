...
const Menu = ({ category, setmenu }) => {
  return (
    <div className='flex flex-col gap-5 px-4 sm:px-6 md:px-12 lg:px-24 mt-16' id='exploremenu'>
      <h1 className='text-2xl sm:text-3xl md:text-4xl font-bold'>Explore our menu</h1>
      <p className='max-w-5xl font-semibold text-sm sm:text-base mt-3 sm:mt-5'>
