          ...
          if (item[items._id] > 0) {
            return (
              ...
              >
                ...
                <img className='w-16 sm:w-20 md:w-24' src={items.image} alt={items.name} />
                ...
                <p className='text-center'>{item[items._id]}</p>
                ...
                <div className='col-span-2 md:hidden text-xs text-gray-900 flex  justify-between'>
                  <p>₹{items.price} each</p>
                  <p>Total: ₹{items.price * item[items._id]}</p>
                </div>
              </div>
            );
          }
